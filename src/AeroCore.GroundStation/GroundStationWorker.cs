...
namespace AeroCore.GroundStation
{
    public class GroundStationWorker : BackgroundService
    {
        ...
        {
            // Optimization: Fetch CultureInfo once per telemetry tick instead of multiple times deep in WriteFormatted.
            // This prevents redundant thread-local property lookups.
